        ...
        <section>
            <div class="page-header min-vh-100">
                <div class="container">
                    <div class="row">
                        {{-- <div
                            class="col-6 d-lg-flex d-none h-100 my-auto p-2 pe-0 position-absolute top-0 end-0 text-center justify-content-center flex-column">
              ...
              background-size: contain;background-repeat:no-repeat;">
                        ...
                        <div class="col-lg-7 col-md-5 p-6 bg-white shadow">
                            <img src="./img/logo.jpg" class="col-12" alt="main_logo">
                        </div>
